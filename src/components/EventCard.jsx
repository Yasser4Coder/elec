        ...
        <div className="relative group">
          ...
          <div className="relative px-7 py-6 bg-[#1F2937] ring-1 ring-[#0F172A] rounded-lg leading-none flex gap-[90px] items-top justify-start space-x-6 transform transition duration-500 hover:scale-105 hover:rotate-1">
            <div className="space-y-2 flex flex-col gap-[16px]">
              <p className="text-[#F1F5F9] text-3xl font-semibold">{title}</p>
              <div className=" flex flex-col gap-[8px]">
                <p className="text-[#CBD5E1] text-lg h-[110px] overflow-hidden">
                  {desc}
                </p>
                <div className="flex flex-col gap-[4px]">
                  ...
                  <p className="text-[#CBD5E1] text-lg">{location}</p>
                </div>
              </div>
